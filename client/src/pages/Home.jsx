...
const Home = () => {
  ...
  useEffect(() => {
    ...
    // Observe all cards - use setTimeout to ensure DOM is ready
    setTimeout(() => {
        ...
        <div className="hero-container">
          <div className="hero-content">
            <div className="hero-badge">
              <span>{homeContent.hero?.badge || 'Creative Ideas That Inspire Growth'}</span>
            </div>
            <h1 className="hero-title">
              <span className="title-line">{homeContent.hero?.titleLine1 || 'Driving Growth Through'}</span>
              <span className="title-line">{homeContent.hero?.titleLine2 || 'Technology, Compliance & Innovation'}</span>
            </h1>
            <p className="hero-description">
              {homeContent.hero?.description || 'Maximise Your Technology Investment, From SEO and Agentic AI to IATF compliance, ESG solutions, Managed IT Services, and Staff Augmentation — we deliver end-to-end expertise to help your business stay competitive and future-proof.'}
            </p>
            <div className="hero-cta">
              <button className="cta-button" onClick={() => document.querySelector('.about-us')?.scrollIntoView({ behavior: 'smooth' })}>
                {homeContent.hero?.ctaButton || 'Get Started'}
              </button>
            </div>
          </div>
          <div className="hero-image">
            <div className="hero-image-container">
              <img 
                src={homeContent.hero?.image || '/images/01.png'} 
